...
import {faPlus, faClose, faSeedling, faCakeCandles} from "@fortawesome/free-solid-svg-icons"
                    ...
                    <div className={modal ? style.modal : style.notmodal}>
                        ...
                        <div className={style.main_modal}>
                            ...
                            <div className={style.btn_contain}>
                                <button className={status === 0 ? style.ctype_l : style.type_l}
                ...
                : <div className={style.d_main}>
                    ...
                    <div className={style.profile_contain}>
                        <div className={style.profile}>
                            <div className={style.name}><span><FontAwesomeIcon className={style.d_icon} icon={faSeedling} /></span> 허브</div>
                            <div className={style.d_date}><span><FontAwesomeIcon className={style.d_icon} icon={faCakeCandles} /></span> 24일</div>
                        </div>
                    </div>
                </div>
            }
